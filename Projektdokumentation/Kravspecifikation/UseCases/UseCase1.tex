...
Når brugeren ønsker at aflæse målingerne, skal data aflæses via det grafiske interface. Denne use case kan kun gennemføres af en person da der kun er et grafisk interface. 
\begin{usecase}
...
\addscenario{Hovedscenario:}{
	\item Bruger tilgår systemet via grafisk brugergrænseflade
